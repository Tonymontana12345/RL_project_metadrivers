...
import random
import numpy as np
# torch는 lazy import로 변경 (torch가 필요한 경우에만 import)
...
# ============================================================ 
# 랜덤 블록 순서 맵 학습용 환경 설정 (새로 추가)
# ============================================================ 

RANDOM_BLOCK_ENV_CONFIG = {
    **FIXED_SEED_ENV_CONFIG,

    # 에피소드마다 블록 순서를 랜덤하게 섞어서 map을 구성
    "randomize_block_order": True,

    # 사용할 블록 타입 목록
    "map_blocks": ["T", "S", "C", "O"],

    # 하나의 맵을 구성하는 블록 개수 (예: 4 → TSCO, OTCS 등)
    "num_map_blocks": 4,
}
...
# 🔥 랜덤 블록 맵 학습 (TSCO 구조를 랜덤 순열로 사용)
#  - 알고리즘이 PPO일 때:  ppo_tsco_random_map_500k
#  - train.py에서 알고리즘을 td3로 바꾸면: td3_tsco_random_map_500k 으로 자동 치환됨
RANDOM_BLOCK_TRAINING = {
    "total_timesteps": 1000000,
    "save_freq": 50000,
    "eval_freq": 25000,
    "n_eval_episodes": 10,
    "model_name": "ppo_tsco_random_map_500k",
}
