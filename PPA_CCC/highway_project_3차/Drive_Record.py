...
def record_driving_gif(model_path, seed=1000, output_name="driving.gif", max_steps=1000):
    ...
    # 환경 설정 (학습 마지막 단계와 동일하게 맞춤)
    env_config = {
        'traffic_mode': 'trigger', 
        'vehicle_config': {'lidar': {'num_lasers': 72, 'distance': 50}, 'side_detector': {'num_lasers': 0}, 'lane_line_detector': {'num_lasers': 0}}, 
        'driving_reward': 3.0, 'speed_reward': 0.2, 
        'out_of_road_penalty': 20.0, 'crash_vehicle_penalty': 20.0, 'crash_object_penalty': 10.0, 
        'crash_sidewalk_penalty': 10.0, 'use_lateral_reward': True, 'success_reward': 50.0, 
        'map': 'TSCO', 'random_traffic': True, 'traffic_density': 0.15,
        'decision_repeat': 2, 'horizon': 2000,
    }
