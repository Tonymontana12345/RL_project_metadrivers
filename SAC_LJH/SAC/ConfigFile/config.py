...
FIXED_SEED_ENV_CONFIG = {
    ...
    "vehicle_config": {
        "lidar": {
            ...
            "distance": 50,      # 70m 감지 거리 (마주오는 차량 조기 감지 - 좌회전 충돌 방지) 
        },
        "side_detector": {
            "num_lasers": 0      # 측면 감지기 활성화 (좌/우 차량 감지). -->2로 변경시 제일 좋음. 차원 문제 때문에 앙상블시 축소 
            
        },
        "lane_line_detector": {
            "num_lasers": 0      # 차선 감지기 활성화 (좌/우 차선 거리) -->2로 변경시 제일 좋음.차원 문제 때문에 앙상블시 축소 
        },
    },
